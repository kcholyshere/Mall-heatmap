...
| 3 | Tracking Insights | Unique footfall, dwell-time and person trajectories |
| 4 | Time Analysis | Filter by time window to compare traffic patterns across periods |

**Tracking (Step 3):** tick *“Enable person tracking”* in Step 1 to follow each person across
frames. This unlocks genuine footfall counts, dwell-time and trajectories (and time-windowed
versions in Step 4) - it needs dense (~25-30 fps) video and is slower than the heatmap detection.
